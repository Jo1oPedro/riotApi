...
$image = imagecreatetruecolor(15000, 15000);
...
$scaleX = 15000 / $bgWidth;
$scaleY = 15000 / $bgHeight;
...
// Draw x and y axes
imageline($image, 0, 7500, 15000, 7500, $black); // x-axis
imageline($image, 7500, 0, 7500, 15000, $black); // y-axis

// Draw a sample plot point
$x = 11250; // x-coordinate
$y = 7500; // y-coordinate
$radius = 5; // point size
...
imagepng($image, __DIR__ . '/MapsImage/classic_map_15k_px.png'); // Save image to file

...
$image = imagecreatetruecolor(14000, 14000);
...
$scaleX = 14000 / $bgWidth;
$scaleY = 14000 / $bgHeight;
...
// Draw x and y axes
imageline($image, 0, 7000, 14000, 7000, $black); // x-axis
imageline($image, 7000, 0, 7000, 14000, $black); // y-axis

// Draw a sample plot point
$x = 10500; // x-coordinate
$y = 7000; // y-coordinate
$radius = 5; // point size
...
imagepng($image, 'classic_map_14k_px.png'); // Save image to file
